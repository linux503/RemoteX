...
const copy = {
  en: {
    ...
    getApp: "Get the app",
    eyebrow: "v0.2.4 · Fast Remote Desktop",
    ...
    copyCmd: "Copy",
    copiedCmd: "Copied",
    footerTag: "RemoteX v0.2.4 · Fast Remote Desktop",
