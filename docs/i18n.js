...
const copy = {
  en: {
    ...
    getApp: "Get the app",
    eyebrow: "v2.0.0 · Fast Remote Desktop",
    ...
    f4d: "Permissions open in the right place and the app can guide users step by step.",
    ...
    copyCmd: "Copy",
    copiedCmd: "Copied",
    footerTag: "RemoteX v2.0.0 · Fast Remote Desktop",
