...
const copy = {
  en: {
    ...
    copyCmd: "Copy",
    copiedCmd: "Copied",
    footerTag: "RemoteX v2.0.3 · Fast Remote Desktop",
...
function applyLang(lang) {
  ...
  document.querySelectorAll("[data-i18n-src]").forEach((el) => {
    ...
    if (key) el.src = `./shots/${lang}/${key}.png?v=20260818k`;
  });
