...
const copy = {
  en: {
    ...
    m5: "Device ID",
    m6: "Unattended",
    shotsTitle: "Looks finished. Feels like a note.",
    shotHome: "Home",
    ...
    f2t: "Cross-platform",
    f2d: "Windows and macOS control each other, same red UI.",
    f3t: "Live stats",
    ...
    dlMacDesc: "One universal installer for Apple Silicon and Intel. Open the app to get a device code.",
    dlMacBtn: "Download for Mac",
    dlWinTitle: "Download for Windows",
    dlWinDesc: "Windows installer is on the way. Use the Mac build today, or watch GitHub Releases.",
    dlWinBtn: "Coming soon",
    dlAll: "All releases",
  ...
  zh: {
    ...
    f2t: "跨平台",
    f2d: "Windows 和 macOS 互相远程，同一套红色界面。",
    f3t: "实时状态",
    ...
    dlTitle: "选你的系统，直接安装。",
    dlMacTitle: "下载 Mac 版",
    dlMacDesc: "一个安装包同时兼容 Apple Silicon 与 Intel。打开即可获得设备码。",
    dlMacBtn: "下载 Mac 版",
    dlWinTitle: "下载 Windows 版",
    dlWinDesc: "Windows 安装包正在准备。现在请用 Mac 版，或关注 GitHub Releases。",
    dlWinBtn: "即将推出",
    dlAll: "全部版本",
